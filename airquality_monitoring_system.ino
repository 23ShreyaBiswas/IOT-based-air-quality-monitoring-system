#include <LiquidCrystal.h> //Header le for LCD
...
tone(led,1000,200); //blink led with turn on time 1000mS, turn o time 200mS
digitalWrite(buz,HIGH); //Turn ON Buzzer
}
else
{
digitalWrite(led,LOW); //jump here if ppm is not greater than threshold and turn o LED
digitalWrite(buz,LOW); //Turn o Buzzer
lcd.setCursor(1,1);
